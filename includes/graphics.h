...
public:
	 ...
	 * Loads an image int othe _spriteSheets map if it doesn't already exist
	...
	/* void blitSurface
	 * Draws a texture to a certain part of the screen as defined by destinationRectangle
	 */
	void blitSurface(SDL_Texture* source, SDL_Rect* sourceRectable, SDL_Rect* destinationRectangle);

...
// Determines which side the collision happened on. Note, this function
// assumes that a collision has occurred and does not check if one has
// actually happened. Nonsense values may result otherwise.
